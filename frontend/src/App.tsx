...
const DEFAULT_SKILLS: Skill[] = [
  {
    ...
    desc: 'React.js, Vite, Node.js, Express.js, HTML5, CSS3. Building clean, responsive UIs and robust REST APIs.',
    pips: 5,
    iconType: 'frontend',
  },
  {
    _id: '2',
    name: 'Agentic AI & RAG Workflows',
    desc: 'LangGraph, FastAPI, ChromaDB Vector Store, Gemini Embeddings, Multi-Agent Preparation Copilot Workflows.',
    pips: 5,
    iconType: 'ai',
  },
  {
    ...
    desc: 'Python, Java, C / C++, TypeScript, SQL. 500+ DSA problems solved, OOP, System Fundamentals.',
    pips: 5,
    iconType: 'backend',
  },
  {
    _id: '4',
    name: 'Database Systems & Systems',
    desc: 'MySQL (DBMS Course Project), SQLite, Java Swing & JDBC (4-Layer ERP), Schema Normalization.',
    pips: 5,
    iconType: 'database',
  },
  {
    _id: '5',
    name: 'Security & Craftsmanship',
    desc: 'RBAC Auth, BCrypt Password Hashing, JWT Tokens, Email OTP Verification, JUnit Unit Testing.',
    pips: 5,
    iconType: 'security',
  },
  {
