          ...
          <div className="container">
            <div className="skills-layout">
              <div className="skills-heading-col">
                <p className="skills-eyebrow" style={{ color: 'var(--accent)', letterSpacing: '0.25em' }}>SKILLS &amp; STACK</p>
                <h2>
                  THE<br />TECH<br />
        ...
        <section id="contact" aria-label="Contact">
          ...
          <div className="container">
            <div className="contact-layout">
              <div>
                <p className="contact-eyebrow" style={{ color: 'var(--accent)', letterSpacing: '0.25em' }}>CONTACT</p>
                ...
                <div className="contact-channels">
                  {profile.email && (
                    <a className="contact-channel" href={`mailto:${profile.email}`}>
                      <svg className="contact-channel-icon" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="1.5">
